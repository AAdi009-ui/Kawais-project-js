...
class AutoRole (commands .Cog ):
    ...
    async def _autorole_humans_reset (self ,ctx ):
        ...
        if data and data [0 ]:
            ...
            embed =discord .Embed (description ="No Autoroles set for humans in this Guild.",
            color =self .color )
    ...
    async def _autorole_bots_reset (self ,ctx ):
        ...
        if data and data [0 ]:
            ...
            embed =discord .Embed (description ="No Autoroles set for Bots in this Guild.",
            color =self .color )
    ...
    async def _autorole_reset_all (self ,ctx ):
        ...
        if data and (data [0 ]or data [1 ]):
            ...
            embed =discord .Embed (description ="No Autoroles set in this Guild.",
            color =self .color )
    ...
    async def _autorole_humans_remove (self ,ctx ,*,role :discord .Role ):
        ...
        if data :
            ...
            if role .id not in humans :
                embed =discord .Embed (description =f"{role.mention} is not in human autoroles.",
                color =self .color )
            else :
            ...
            embed =discord .Embed (description =f"No Autoroles set in this guild for humans.",
            color =self .color )
    ...
    async def _autorole_bots_remove (self ,ctx ,*,role :discord .Role ):
        ...
        if data :
            ...
            if role .id not in bots :
                embed =discord .Embed (description =f"{role.mention} is not in bot autoroles.",
                color =self .color )
            else :
                bots .remove (role .id )
                async with aiosqlite .connect (DATABASE_PATH )as db :
            ...
            embed =discord .Embed (description =f"No Autoroles set in this guild for bots.",
            color =self .color )
