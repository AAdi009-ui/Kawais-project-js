...
class Welcomer (commands .Cog ):
    ...
    async def simple_setup (self ,ctx ):
        ...
        async def submit_callback (interaction ):
            ...
            if message_content :
                ...
                await interaction .response .send_message ("<:icon_tick:1372375089668161597> Welcome message setup completed!")
    ...
    async def embed_setup (self ,ctx ):
        ...
        async def submit_callback (interaction ):
            ...
            await interaction .response .send_message ("<:icon_tick:1372375089668161597> Embed welcome message setup completed!")
    ...
    async def greet_reset (self ,ctx ):
        ...
        async def yes_button_callback (interaction ):
            ...
            embed .title ="<:icon_tick:1372375089668161597> Success"
    ...
    async def greet_channel (self ,ctx ):
        ...
        def generate_view (page ):
            ...
            async def select_callback (interaction :discord .Interaction ):
                ...
                await ctx .send (f"<:icon_tick:1372375089668161597> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete (self ,ctx ,time :str ):
        ...
        await ctx .send (f"<:icon_tick:1372375089668161597> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
