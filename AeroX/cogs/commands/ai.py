...
Server: https://discord.gg/kawaiscans"""
    ...
    async def ai_activate (self ,ctx :commands .Context ,channel :discord .TextChannel =None ):
        ...
        if not ctx .author .guild_permissions .manage_channels :
            embed =discord .Embed (
            title ="<:icon_cross:1372375094336425986> Permission Denied",
        ...
        embed =discord .Embed (
        title ="<:icon_tick:1372375089668161597> AI Chatbot Activated",
    ...
    async def handle_trivia_answer (self ,interaction :discord .Interaction ,channel_id :int ,selected_answer :str ):
        ...
        if is_correct 
        else f"<:icon_cross:1372375094336425986> Incorrect. The answer was **{game['current_answer']}**. Your guess: **{selected_answer}**. -1 point."
        )
