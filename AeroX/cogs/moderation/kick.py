...
class Kick (commands .Cog ):
    ...
    async def kick_command (self ,ctx ,member :discord .Member ,*,reason :str =None ):
        ...
        embed =discord .Embed (
        description =(
        f"**<:user:1373171037998682214> Target User:** [{member}](https://discord.com/users/{member.id})\n"
        f"<a:mention:1373169555849085028> **User Mention:** {member.mention}\n"
        f"<:commands:1374327912496627843> **Reason:** {reason}\n"
        f"<:icon_tick:1372375089668161597> **DM Sent:** {dm_status}"
        ),
        color =self .color 
        )
