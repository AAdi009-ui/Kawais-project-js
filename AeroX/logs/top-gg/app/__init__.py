...
async def setup_database ():
    async with aiosqlite .connect ("db/votes.db")as db :
        await db .execute ("""
...
async def topgg ():
    ...
    "embeds":[
    {
    "description":"**[Voted Strelizia](https://top.gg/bot/1144179659735572640)**\n💖 Thank you for voting for Strelizia on Top.gg, your support means everything to us!\n",
    "fields":[
    ...
    "footer":{
    "text":f"Voter ID: {user_id} | AeroX Development | {footer_time}",
